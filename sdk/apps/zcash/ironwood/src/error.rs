...
/// application interface without being stable or actionable at the transport.
...
impl ErrorCode {
    ...
    // Only the host-only whole-PCZT scanner (`wire::scan`) spells it this
    // way; the streaming parser returns `Error::Capacity` directly.
    #[cfg(feature = "test")]
