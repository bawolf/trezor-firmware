...
/// Clears the secret authorizing scalar, retaining its cached public key.
/// Discard this key after clearing it; other copies and derived keys remain.
#[cfg(feature = "zeroize")]
impl zeroize::Zeroize for SpendAuthorizingKey {
    fn zeroize(&mut self) {
