...
class TR:
    ...
    extapp__mainnet: str = "Mainnet"
    extapp__spending_key: str = "Spending key"
    extapp__spending_key_template: str = "{0} will receive the spending key of Zcash account #{1} ({2}) and can spend all of its funds."
    extapp__testnet: str = "Testnet"
