...
class TR:
    ...
    pin__disabled: str = "PIN protection turned\u00a0off."
    pin__enabled: str = "PIN protection turned\u00a0on."
    pin__enter: str = "Enter PIN"
    pin__enter_new: str = "Enter new PIN"
    pin__entered_not_valid: str = "The PIN you have entered is not valid."
    pin__info: str = "A PIN will be required to access this device."
    pin__invalid_pin: str = "Invalid PIN"
    pin__last_attempt: str = "Last"
    ...
    zcash__total_actions: str = "Total actions"
