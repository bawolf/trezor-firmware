...
#[no_mangle]
#[rustfmt::skip]
pub static mp_module_trezorzcash: Module = obj_module! {
    ...
    ///     (action_index, receiver, value, memo_kind, memo, user_address) where
    ...
    ///     BLAKE2b-256 of the memo), and user_address is the wallet's
    ///     unverified recipient string or None; kind 2 is the review, payload
