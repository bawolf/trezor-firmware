...
#define APP_HEADER_MAX_ID_LEN 32U
#define APP_HEADER_MAX_NAME_LEN 32U
#define APP_HEADER_MAX_VENDOR_LEN 32U
#define APP_HEADER_CURVES_MAX_LEN 64U
#define APP_HEADER_PATHS_MAX_LEN 256U

#define APP_HEADER_MAX_SIZE 512U
