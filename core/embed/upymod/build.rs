...
fn main() -> Result<()> {
    xbuild::build(|lib| {
        ...
        if cfg!(feature = "zcash_shielded") {
            lib.add_define("USE_ZCASH_SHIELDED", Some("1"));
        }
...
impl<'a> MpyBuilder<'a> {
    ...
    fn create_sed_scripts(&self) -> Result<Vec<String>> {
        ...
        let zcash_shielded = py_bool(cfg!(feature = "zcash_shielded"));
        ...
        let mut exprs: Vec<String> = vec![
            ...
            format!(r"s/utils\.USE_ZCASH_SHIELDED/{zcash_shielded}/g"),
