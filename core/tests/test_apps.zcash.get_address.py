...
if not utils.BITCOIN_ONLY:
    ...
    from apps.zcash import get_address, helpers
...
class TestZcashGetAddress(unittest.TestCase):
    def setUp(self):
        self.patchers = []
        self.calls = []
    ...
    def test_chunkify_is_off_unless_the_host_asks(self):
        """The host opts in to chunking, as with Bitcoin's `GetAddress.chunkify`."""
    ...
    def test_weak_backup_warning_precedes_raw_16_byte_seed_derivation(self):
        ...
        self.assertEqual(warning["br_name"], "zcash_weak_backup")
