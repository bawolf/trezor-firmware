...
class TestZcashReceiver(unittest.TestCase):
    def setUp(self):
        from trezorzcash import derive_receiver, derive_viewing_key
    ...
    def test_module_exposes_no_spending_key_boundary(self):
        ...
        self.assertFalse(hasattr(trezorzcash, "derive_spending_key"))
        self.assertFalse(hasattr(trezorzcash, "derive_spend_authorizing_key"))


@unittest.skipUnless(utils.USE_ZCASH_SHIELDED, "requires USE_ZCASH_SHIELDED")
class TestZcashSessionHandle(unittest.TestCase):
    ...
    *without touching the live request*: destroying it there would turn a stray
    ...
    def setUp(self):
        ...
        self.scratch = bytearray(trezorzcash.SCRATCH_BYTES)
